...
Η είσοδος στην εφαρμογή είναι εμπνευσμένη από κινηματογραφικά websites που βασίζονται σε scroll-driven αφήγηση — όπως η επίσημη σελίδα του GTA VI. Ο επισκέπτης ξεκινάει με ένα μαύρο φόντο και την προαναφερθείσα ατάκα, κάνει scroll για να δει το μανιφέστο των δύο πλευρών του ήρωα, και στη συνέχεια επιλέγει σε ποιο σύμπαν θέλει να μπει.
